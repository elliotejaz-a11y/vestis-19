            ...
            function: {
              ...
              parameters: {
                ...
                properties: {
                  ...
                  category: { type: 'string', enum: ['tops', 'bottoms', 'dresses', 'jumpers', 'outerwear', 'shoes', 'hats', 'accessories'], description: 'Clothing category. Use "jumpers" for sweaters, jumpers, knit pullovers, cardigans, and similar knitwear. Use "hats" for hats, caps, beanies, headbands, and headwear. Use "accessories" for belts, watches, sunglasses, scarves, bags, jewelry, and non-headwear accessories.' },
