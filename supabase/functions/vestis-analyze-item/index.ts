...
serve(async (req) => {
  ...
  try {
        ...
        messages: [
          {
            ...
            content: [
              {
                type: "text",
                text: "You are a fashion expert AI. Analyze this clothing item photo and call the classify_clothing tool with the result. Identify: the exact type/category, primary color, fabric/material, a descriptive name (e.g. 'Navy Linen Blazer'), and estimate its retail value in NZD. Consider brand quality indicators, fabric, condition, and style when estimating price. Be specific and accurate.",
              },
              {
                type: "image_url",
        ...
        tools: [
          {
            ...
            function: {
              ...
              description: "Classify a clothing item from a photo and estimate its retail value in NZD",
              parameters: {
                type: "object",
                properties: {
                  ...
                  category: {
                    ...
                    description: "Use hats for all headwear, jumpers for knitwear/sweaters, accessories for bags/belts/jewellery/watches/sunglasses",
                  },
                  ...
                  style_tags: { type: "array", items: { type: "string" }, description: "e.g. casual, formal, streetwear, vintage, sporty" },
    ...
    console.log("Gemini response choices:", JSON.stringify(aiData.choices?.length), "finish_reason:", aiData.choices?.[0]?.finish_reason);
