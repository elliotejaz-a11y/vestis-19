...
3a. LAYERING RULE: Outerwear (puffer, jacket, coat) and a jumper/hoodie are mutually exclusive — include one or the other, never both. You must never select 2 jumpers, 2 hoodies, or 2 outerwear items.
