        ...
        <div className="space-y-3">
          ...
          >
            {socialLoading === "apple" ? (
              ...
              <svg width="16" height="19" viewBox="0 0 15 18" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className="shrink-0">
                <path d="M14.94 13.34c-.35.81-.52 1.17-.97 1.89-.63.99-1.52 2.23-2.62 2.24-1.23.01-1.55-.8-3.22-.79-1.67.01-2.02.81-3.25.8-1.1-.02-1.94-1.13-2.57-2.13C.65 12.48.22 9.43 1.5 7.4c.91-1.44 2.35-2.28 3.7-2.28 1.38 0 2.24.81 3.37.81 1.1 0 1.77-.81 3.36-.81.6 0 2.73.23 4.02 1.74-3.54 1.93-2.96 6.98.99 8.48ZM10.17 3.24c.49-.63.87-1.52.73-2.43-.81.06-1.76.57-2.31 1.24-.5.6-.92 1.5-.76 2.37.89.03 1.81-.49 2.34-1.18Z"/>
              </svg>
            )}
            Continue with Apple
          </button>
