        ...
        <div className="space-y-3">
          ...
          >
            {socialLoading === "apple" ? (
              ...
              <svg width="17" height="20" viewBox="0 0 17 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className="shrink-0">
                <path d="M8.286 4.882c.893 0 2.013-.604 2.68-1.41.6-.723 1.037-1.734 1.037-2.745 0-.137-.012-.275-.037-.387-.988.037-2.176.66-2.893 1.497-.562.636-1.074 1.635-1.074 2.658 0 .15.025.3.037.35.063.012.163.025.263.025l.013.012h-.026Zm-2.3 14.006C4.787 18.888 3.2 16.839 3.2 16.839c-1.675-2.17-1.675-4.153-1.675-4.153 0-2.32 1.487-3.355 2.88-3.355.45 0 1.325.2 2.025.2.7 0 1.55-.225 2.225-.225 1.725 0 2.95 1.08 2.95 1.08s-1.725 1.005-1.725 3.08c0 2.42 2.15 3.255 2.15 3.255s-1.505 4.355-3.53 4.355c-.75 0-1.338-.45-2.175-.45-.838 0-1.563.488-2.338.488v-.226Z"/>
              </svg>
            )}
            Continue with Apple
          </button>
