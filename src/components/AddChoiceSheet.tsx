...
import { Camera, Layers, ChevronRight, UserSquare2, Lock, Search, ShoppingBag } from "lucide-react";
        ...
        <div className="mt-5 space-y-3">
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-[11px] text-muted-foreground">Pick from 120+ essentials with colour options</p>
            </div>
            <ChevronRight className="w-4 h-4 text-muted-foreground" />
          </button>
